...
function initSearch() {
    ...
    searchInput.addEventListener("input", async () => {
        ...
        try {
            ...
            const filtered = results.filter(media => media.poster_path && (media.media_type === "movie" || media.media_type === "tv"));
...
function renderMediaList(container, mediaList, defaultType, heading) {
    container.innerHTML = "";
    if (heading) {
